...
// jump & subroutine
static void op_JMP(sb_6502_t* cpu, sb_bus_t* bus, uint8_t opcode) { cpu->pc = cpu->addr_abs; }
static void op_JSR(sb_6502_t* cpu, sb_bus_t* bus, uint8_t opcode) {
...
void sb_6502_init_opcodes(void) {
  ...
  static const opcode_def_t lda[] = {
    { 0xA9, "LDA", 2, 2, op_LDA, cycle_read_immediate },
    { 0xA5, "LDA", 2, 3, op_LDA, cycle_read_zp },
    { 0xB5, "LDA", 2, 4, op_LDA, cycle_read_zpx },
    { 0xAD, "LDA", 3, 4, op_LDA, cycle_read_absolute },
    { 0xBD, "LDA", 3, 4, op_LDA, cycle_read_absx },
    { 0xB9, "LDA", 3, 4, op_LDA, cycle_read_absy },
    { 0xA1, "LDA", 2, 6, op_LDA, cycle_read_idrx },
    { 0xB1, "LDA", 2, 5, op_LDA, cycle_read_idry },
  };
  assign_defs(lda, sizeof(lda) / sizeof(lda[0]));

  static const opcode_def_t ldx[] = {
    { 0xA2, "LDX", 2, 2, op_LDX, cycle_read_immediate },
    { 0xA6, "LDX", 2, 3, op_LDX, cycle_read_zp },
    { 0xB6, "LDX", 2, 4, op_LDX, cycle_read_zpx },
    { 0xAE, "LDX", 3, 4, op_LDX, cycle_read_absolute },
    { 0xBE, "LDX", 3, 4, op_LDX, cycle_read_absy },
  };
  assign_defs(ldx, sizeof(ldx) / sizeof(ldx[0]));

  static const opcode_def_t ldy[] = {
    { 0xA0, "LDY", 2, 2, op_LDY, cycle_read_immediate },
    { 0xA4, "LDY", 2, 3, op_LDY, cycle_read_zp },
    { 0xB4, "LDY", 2, 4, op_LDY, cycle_read_zpx },
    { 0xAC, "LDY", 3, 4, op_LDY, cycle_read_absolute },
    { 0xBC, "LDY", 3, 4, op_LDY, cycle_read_absx },
  };
  assign_defs(ldy, sizeof(ldy) / sizeof(ldy[0]));

  static const opcode_def_t sta[] = {
    { 0x85, "STA", 2, 3, op_STA, cycle_write_zp },
    { 0x95, "STA", 2, 4, op_STA, cycle_write_zpx },
    { 0x8D, "STA", 3, 4, op_STA, cycle_write_absolute },
    { 0x9D, "STA", 3, 5, op_STA, cycle_write_absx },
    { 0x99, "STA", 3, 5, op_STA, cycle_write_absy },
    { 0x81, "STA", 2, 6, op_STA, cycle_write_idrx },
    { 0x91, "STA", 2, 6, op_STA, cycle_write_idry },
  };
  assign_defs(sta, sizeof(sta) / sizeof(sta[0]));

  static const opcode_def_t stx[] = {
    { 0x86, "STX", 2, 3, op_STX, cycle_write_zp },
    { 0x96, "STX", 2, 4, op_STX, cycle_write_zpx },
    { 0x8E, "STX", 3, 4, op_STX, cycle_write_absolute },
  };
  assign_defs(stx, sizeof(stx) / sizeof(stx[0]));

  static const opcode_def_t sty[] = {
    { 0x84, "STY", 2, 3, op_STY, cycle_write_zp },
    { 0x94, "STY", 2, 4, op_STY, cycle_write_zpx },
    { 0x8C, "STY", 3, 4, op_STY, cycle_write_absolute },
  };
  assign_defs(sty, sizeof(sty) / sizeof(sty[0]));

  static const opcode_def_t adc[] = {
    { 0x69, "ADC", 2, 2, op_ADC, cycle_read_immediate },
    { 0x65, "ADC", 2, 3, op_ADC, cycle_read_zp },
    { 0x75, "ADC", 2, 4, op_ADC, cycle_read_zpx },
    { 0x6D, "ADC", 3, 4, op_ADC, cycle_read_absolute },
    { 0x7D, "ADC", 3, 4, op_ADC, cycle_read_absx },
    { 0x79, "ADC", 3, 4, op_ADC, cycle_read_absy },
    { 0x61, "ADC", 2, 6, op_ADC, cycle_read_idrx },
    { 0x71, "ADC", 2, 5, op_ADC, cycle_read_idry },
  };
  assign_defs(adc, sizeof(adc) / sizeof(adc[0]));

  static const opcode_def_t sbc[] = {
    { 0xE9, "SBC", 2, 2, op_SBC, cycle_read_immediate },
    { 0xE5, "SBC", 2, 3, op_SBC, cycle_read_zp },
    { 0xF5, "SBC", 2, 4, op_SBC, cycle_read_zpx },
    { 0xED, "SBC", 3, 4, op_SBC, cycle_read_absolute },
    { 0xFD, "SBC", 3, 4, op_SBC, cycle_read_absx },
    { 0xF9, "SBC", 3, 4, op_SBC, cycle_read_absy },
    { 0xE1, "SBC", 2, 6, op_SBC, cycle_read_idrx },
    { 0xF1, "SBC", 2, 5, op_SBC, cycle_read_idry },
  };
  assign_defs(sbc, sizeof(sbc) / sizeof(sbc[0]));
  opcodes[0xEB] = opcodes[0xE9]; // undocumented SBC alias

  static const opcode_def_t and_op[] = {
    { 0x29, "AND", 2, 2, op_AND, cycle_read_immediate },
    { 0x25, "AND", 2, 3, op_AND, cycle_read_zp },
    { 0x35, "AND", 2, 4, op_AND, cycle_read_zpx },
    { 0x2D, "AND", 3, 4, op_AND, cycle_read_absolute },
    { 0x3D, "AND", 3, 4, op_AND, cycle_read_absx },
    { 0x39, "AND", 3, 4, op_AND, cycle_read_absy },
    { 0x21, "AND", 2, 6, op_AND, cycle_read_idrx },
    { 0x31, "AND", 2, 5, op_AND, cycle_read_idry },
  };
  assign_defs(and_op, sizeof(and_op) / sizeof(and_op[0]));

  static const opcode_def_t ora[] = {
    { 0x09, "ORA", 2, 2, op_ORA, cycle_read_immediate },
    { 0x05, "ORA", 2, 3, op_ORA, cycle_read_zp },
    { 0x15, "ORA", 2, 4, op_ORA, cycle_read_zpx },
    { 0x0D, "ORA", 3, 4, op_ORA, cycle_read_absolute },
    { 0x1D, "ORA", 3, 4, op_ORA, cycle_read_absx },
    { 0x19, "ORA", 3, 4, op_ORA, cycle_read_absy },
    { 0x01, "ORA", 2, 6, op_ORA, cycle_read_idrx },
    { 0x11, "ORA", 2, 5, op_ORA, cycle_read_idry },
  };
  assign_defs(ora, sizeof(ora) / sizeof(ora[0]));

  static const opcode_def_t eor[] = {
    { 0x49, "EOR", 2, 2, op_EOR, cycle_read_immediate },
    { 0x45, "EOR", 2, 3, op_EOR, cycle_read_zp },
    { 0x55, "EOR", 2, 4, op_EOR, cycle_read_zpx },
    { 0x4D, "EOR", 3, 4, op_EOR, cycle_read_absolute },
    { 0x5D, "EOR", 3, 4, op_EOR, cycle_read_absx },
    { 0x59, "EOR", 3, 4, op_EOR, cycle_read_absy },
    { 0x41, "EOR", 2, 6, op_EOR, cycle_read_idrx },
    { 0x51, "EOR", 2, 5, op_EOR, cycle_read_idry },
  };
  assign_defs(eor, sizeof(eor) / sizeof(eor[0]));

  static const opcode_def_t cmp[] = {
    { 0xC9, "CMP", 2, 2, op_CMP, cycle_read_immediate },
    { 0xC5, "CMP", 2, 3, op_CMP, cycle_read_zp },
    { 0xD5, "CMP", 2, 4, op_CMP, cycle_read_zpx },
    { 0xCD, "CMP", 3, 4, op_CMP, cycle_read_absolute },
    { 0xDD, "CMP", 3, 4, op_CMP, cycle_read_absx },
    { 0xD9, "CMP", 3, 4, op_CMP, cycle_read_absy },
    { 0xC1, "CMP", 2, 6, op_CMP, cycle_read_idrx },
    { 0xD1, "CMP", 2, 5, op_CMP, cycle_read_idry },
  };
  assign_defs(cmp, sizeof(cmp) / sizeof(cmp[0]));

  static const opcode_def_t cpx[] = {
    { 0xE0, "CPX", 2, 2, op_CPX, cycle_read_immediate },
    { 0xE4, "CPX", 2, 3, op_CPX, cycle_read_zp },
    { 0xEC, "CPX", 3, 4, op_CPX, cycle_read_absolute },
  };
  assign_defs(cpx, sizeof(cpx) / sizeof(cpx[0]));

  static const opcode_def_t cpy[] = {
    { 0xC0, "CPY", 2, 2, op_CPY, cycle_read_immediate },
    { 0xC4, "CPY", 2, 3, op_CPY, cycle_read_zp },
    { 0xCC, "CPY", 3, 4, op_CPY, cycle_read_absolute },
  };
  assign_defs(cpy, sizeof(cpy) / sizeof(cpy[0]));

  static const opcode_def_t bit_op[] = {
    { 0x24, "BIT", 2, 3, op_BIT, cycle_read_zp },
    { 0x2C, "BIT", 3, 4, op_BIT, cycle_read_absolute },
  };
  ...
  static const opcode_def_t asl[] = {
    { 0x0A, "ASL", 1, 2, op_ASL, cycle_implied },  { 0x06, "ASL", 2, 5, op_ASL, cycle_rmw_zp },
    { 0x16, "ASL", 2, 6, op_ASL, cycle_rmw_zpx },  { 0x0E, "ASL", 3, 6, op_ASL, cycle_rmw_abs },
    { 0x1E, "ASL", 3, 7, op_ASL, cycle_rmw_absx },
  };
  assign_defs(asl, sizeof(asl) / sizeof(asl[0]));

  static const opcode_def_t lsr[] = {
    { 0x4A, "LSR", 1, 2, op_LSR, cycle_implied },  { 0x46, "LSR", 2, 5, op_LSR, cycle_rmw_zp },
    { 0x56, "LSR", 2, 6, op_LSR, cycle_rmw_zpx },  { 0x4E, "LSR", 3, 6, op_LSR, cycle_rmw_abs },
    { 0x5E, "LSR", 3, 7, op_LSR, cycle_rmw_absx },
  };
  assign_defs(lsr, sizeof(lsr) / sizeof(lsr[0]));

  static const opcode_def_t rol[] = {
    { 0x2A, "ROL", 1, 2, op_ROL, cycle_implied },  { 0x26, "ROL", 2, 5, op_ROL, cycle_rmw_zp },
    { 0x36, "ROL", 2, 6, op_ROL, cycle_rmw_zpx },  { 0x2E, "ROL", 3, 6, op_ROL, cycle_rmw_abs },
    { 0x3E, "ROL", 3, 7, op_ROL, cycle_rmw_absx },
  };
  assign_defs(rol, sizeof(rol) / sizeof(rol[0]));

  static const opcode_def_t ror[] = {
    { 0x6A, "ROR", 1, 2, op_ROR, cycle_implied },  { 0x66, "ROR", 2, 5, op_ROR, cycle_rmw_zp },
    { 0x76, "ROR", 2, 6, op_ROR, cycle_rmw_zpx },  { 0x6E, "ROR", 3, 6, op_ROR, cycle_rmw_abs },
    { 0x7E, "ROR", 3, 7, op_ROR, cycle_rmw_absx },
  };
  assign_defs(ror, sizeof(ror) / sizeof(ror[0]));

  static const opcode_def_t inc[] = {
    { 0xE6, "INC", 2, 5, op_INC, cycle_rmw_zp },
    { 0xF6, "INC", 2, 6, op_INC, cycle_rmw_zpx },
    { 0xEE, "INC", 3, 6, op_INC, cycle_rmw_abs },
    { 0xFE, "INC", 3, 7, op_INC, cycle_rmw_absx },
  };
  assign_defs(inc, sizeof(inc) / sizeof(inc[0]));

  static const opcode_def_t dec[] = {
    { 0xC6, "DEC", 2, 5, op_DEC, cycle_rmw_zp },
    { 0xD6, "DEC", 2, 6, op_DEC, cycle_rmw_zpx },
    { 0xCE, "DEC", 3, 6, op_DEC, cycle_rmw_abs },
    { 0xDE, "DEC", 3, 7, op_DEC, cycle_rmw_absx },
  };
  ...
  static const opcode_def_t implied_ops[] = {
    { 0xAA, "TAX", 1, 2, op_TAX, cycle_implied }, { 0x8A, "TXA", 1, 2, op_TXA, cycle_implied },
    { 0xA8, "TAY", 1, 2, op_TAY, cycle_implied }, { 0x98, "TYA", 1, 2, op_TYA, cycle_implied },
    { 0xBA, "TSX", 1, 2, op_TSX, cycle_implied }, { 0x9A, "TXS", 1, 2, op_TXS, cycle_implied },
    { 0xE8, "INX", 1, 2, op_INX, cycle_implied }, { 0xC8, "INY", 1, 2, op_INY, cycle_implied },
    { 0xCA, "DEX", 1, 2, op_DEX, cycle_implied }, { 0x88, "DEY", 1, 2, op_DEY, cycle_implied },
    { 0x18, "CLC", 1, 2, op_CLC, cycle_implied }, { 0x38, "SEC", 1, 2, op_SEC, cycle_implied },
    { 0x58, "CLI", 1, 2, op_CLI, cycle_implied }, { 0x78, "SEI", 1, 2, op_SEI, cycle_implied },
    { 0xB8, "CLV", 1, 2, op_CLV, cycle_implied }, { 0xD8, "CLD", 1, 2, op_CLD, cycle_implied },
    { 0xF8, "SED", 1, 2, op_SED, cycle_implied }, { 0xEA, "NOP", 1, 2, op_NOP, cycle_implied },
    { 0x1A, "NOP", 1, 2, op_NOP, cycle_implied }, { 0x3A, "NOP", 1, 2, op_NOP, cycle_implied },
    { 0x5A, "NOP", 1, 2, op_NOP, cycle_implied }, { 0x7A, "NOP", 1, 2, op_NOP, cycle_implied },
    { 0xDA, "NOP", 1, 2, op_NOP, cycle_implied }, { 0xFA, "NOP", 1, 2, op_NOP, cycle_implied },
  };
  assign_defs(implied_ops, sizeof(implied_ops) / sizeof(implied_ops[0]));

  // Stack operations.
  static const opcode_def_t stack_ops[] = {
    { 0x48, "PHA", 1, 3, op_PHA, cycle_push },
    { 0x08, "PHP", 1, 3, op_PHP, cycle_push },
    { 0x68, "PLA", 1, 4, op_PLA, cycle_pull },
    { 0x28, "PLP", 1, 4, op_PLP, cycle_pull },
  };
  assign_defs(stack_ops, sizeof(stack_ops) / sizeof(stack_ops[0]));

  // Control transfer.
  static const opcode_def_t jumps[] = {
    { 0x4C, "JMP", 3, 3, op_JMP, cycle_jmp_abs }, { 0x6C, "JMP", 3, 5, op_JMP, cycle_jmp_ind },
    { 0x20, "JSR", 3, 6, op_JSR, cycle_jsr },     { 0x60, "RTS", 1, 6, op_RTS, cycle_rts },
    { 0x40, "RTI", 1, 6, op_RTI, cycle_rti },     { 0x00, "BRK", 2, 7, op_BRK, cycle_brk },
  };
  assign_defs(jumps, sizeof(jumps) / sizeof(jumps[0]));

  // Branches: all 2 bytes, page_penalty = true.
  static const opcode_def_t branches[] = {
    { 0x90, "BCC", 2, 2, op_NOP, cycle_branch }, { 0xB0, "BCS", 2, 2, op_NOP, cycle_branch },
    { 0xF0, "BEQ", 2, 2, op_NOP, cycle_branch }, { 0xD0, "BNE", 2, 2, op_NOP, cycle_branch },
    { 0x30, "BMI", 2, 2, op_NOP, cycle_branch }, { 0x10, "BPL", 2, 2, op_NOP, cycle_branch },
    { 0x50, "BVC", 2, 2, op_NOP, cycle_branch }, { 0x70, "BVS", 2, 2, op_NOP, cycle_branch },
  };
  ...
  static const opcode_def_t nop_imm[] = {
    { 0x80, "NOP", 2, 2, op_NOP, cycle_read_immediate },
    { 0x82, "NOP", 2, 2, op_NOP, cycle_read_immediate },
    { 0x89, "NOP", 2, 2, op_NOP, cycle_read_immediate },
    { 0xC2, "NOP", 2, 2, op_NOP, cycle_read_immediate },
    { 0xE2, "NOP", 2, 2, op_NOP, cycle_read_immediate },
    { 0x04, "NOP", 2, 3, op_NOP, cycle_read_zp },
    { 0x44, "NOP", 2, 3, op_NOP, cycle_read_zp },
    { 0x64, "NOP", 2, 3, op_NOP, cycle_read_zp },
    { 0x14, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0x34, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0x54, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0x74, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0xD4, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0xF4, "NOP", 2, 4, op_NOP, cycle_read_zpx },
    { 0x0C, "NOP", 3, 4, op_NOP, cycle_read_absolute },
    { 0x1C, "NOP", 3, 4, op_NOP, cycle_read_absx },
    { 0x3C, "NOP", 3, 4, op_NOP, cycle_read_absx },
    { 0x5C, "NOP", 3, 4, op_NOP, cycle_read_absx },
    { 0x7C, "NOP", 3, 4, op_NOP, cycle_read_absx },
    { 0xDC, "NOP", 3, 4, op_NOP, cycle_read_absx },
    { 0xFC, "NOP", 3, 4, op_NOP, cycle_read_absx },
  };
  ...
  static const opcode_def_t illegal_ops[] = {
    { 0xA7, "LAX", 2, 3, op_LAX, cycle_read_zp },
    { 0xB7, "LAX", 2, 4, op_LAX, cycle_read_zpx },
    { 0xAF, "LAX", 3, 4, op_LAX, cycle_read_absolute },
    { 0xBF, "LAX", 3, 4, op_LAX, cycle_read_absy },
    { 0xA3, "LAX", 2, 6, op_LAX, cycle_read_idrx },
    { 0xB3, "LAX", 2, 5, op_LAX, cycle_read_idry },
    { 0x87, "SAX", 2, 3, op_SAX, cycle_write_zp },
    { 0x97, "SAX", 2, 4, op_SAX, cycle_write_zpx },
    { 0x8F, "SAX", 3, 4, op_SAX, cycle_write_absolute },
    { 0x83, "SAX", 2, 6, op_SAX, cycle_write_idrx },
    { 0xC7, "DCP", 2, 5, op_DCP, cycle_rmw_zp },
    { 0xD7, "DCP", 2, 6, op_DCP, cycle_rmw_zpx },
    { 0xCF, "DCP", 3, 6, op_DCP, cycle_rmw_abs },
    { 0xDF, "DCP", 3, 7, op_DCP, cycle_rmw_absx },
    { 0xDB, "DCP", 3, 7, op_DCP, cycle_rmw_absy },
    { 0xC3, "DCP", 2, 8, op_DCP, cycle_rmw_idrx },
    { 0xD3, "DCP", 2, 8, op_DCP, cycle_rmw_idry },
    { 0xE7, "ISB", 2, 5, op_ISB, cycle_rmw_zp },
    { 0xF7, "ISB", 2, 6, op_ISB, cycle_rmw_zpx },
    { 0xEF, "ISB", 3, 6, op_ISB, cycle_rmw_abs },
    { 0xFF, "ISB", 3, 7, op_ISB, cycle_rmw_absx },
    { 0xFB, "ISB", 3, 7, op_ISB, cycle_rmw_absy },
    { 0xE3, "ISB", 2, 8, op_ISB, cycle_rmw_idrx },
    { 0xF3, "ISB", 2, 8, op_ISB, cycle_rmw_idry },
    { 0x07, "SLO", 2, 5, op_SLO, cycle_rmw_zp },
    { 0x17, "SLO", 2, 6, op_SLO, cycle_rmw_zpx },
    { 0x0F, "SLO", 3, 6, op_SLO, cycle_rmw_abs },
    { 0x1F, "SLO", 3, 7, op_SLO, cycle_rmw_absx },
    { 0x1B, "SLO", 3, 7, op_SLO, cycle_rmw_absy },
    { 0x03, "SLO", 2, 8, op_SLO, cycle_rmw_idrx },
    { 0x13, "SLO", 2, 8, op_SLO, cycle_rmw_idry },
    { 0x27, "RLA", 2, 5, op_RLA, cycle_rmw_zp },
    { 0x37, "RLA", 2, 6, op_RLA, cycle_rmw_zpx },
    { 0x2F, "RLA", 3, 6, op_RLA, cycle_rmw_abs },
    { 0x3F, "RLA", 3, 7, op_RLA, cycle_rmw_absx },
    { 0x3B, "RLA", 3, 7, op_RLA, cycle_rmw_absy },
    { 0x23, "RLA", 2, 8, op_RLA, cycle_rmw_idrx },
    { 0x33, "RLA", 2, 8, op_RLA, cycle_rmw_idry },
    { 0x47, "SRE", 2, 5, op_SRE, cycle_rmw_zp },
    { 0x57, "SRE", 2, 6, op_SRE, cycle_rmw_zpx },
    { 0x4F, "SRE", 3, 6, op_SRE, cycle_rmw_abs },
    { 0x5F, "SRE", 3, 7, op_SRE, cycle_rmw_absx },
    { 0x5B, "SRE", 3, 7, op_SRE, cycle_rmw_absy },
    { 0x43, "SRE", 2, 8, op_SRE, cycle_rmw_idrx },
    { 0x53, "SRE", 2, 8, op_SRE, cycle_rmw_idry },
    { 0x67, "RRA", 2, 5, op_RRA, cycle_rmw_zp },
    { 0x77, "RRA", 2, 6, op_RRA, cycle_rmw_zpx },
    { 0x6F, "RRA", 3, 6, op_RRA, cycle_rmw_abs },
    { 0x7F, "RRA", 3, 7, op_RRA, cycle_rmw_absx },
    { 0x7B, "RRA", 3, 7, op_RRA, cycle_rmw_absy },
    { 0x63, "RRA", 2, 8, op_RRA, cycle_rmw_idrx },
    { 0x73, "RRA", 2, 8, op_RRA, cycle_rmw_idry },
    { 0x0B, "ANC", 2, 2, op_ANC, cycle_read_immediate },
    { 0x2B, "ANC", 2, 2, op_ANC, cycle_read_immediate },
    { 0x4B, "ALR", 2, 2, op_ALR, cycle_read_immediate },
    { 0x6B, "ARR", 2, 2, op_ARR, cycle_read_immediate },
    { 0xAB, "LXA", 2, 2, op_LXA, cycle_read_immediate },
    { 0xCB, "SBX", 2, 2, op_SBX, cycle_read_immediate },
    // SHY/SHX: undocumented stores with address-bus AND effect
    { 0x9C, "SHY", 3, 5, op_SHY, cycle_write_absx },
    { 0x9E, "SHX", 3, 5, op_SHX, cycle_write_absy },
  };
