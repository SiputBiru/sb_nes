...
static void op_CLD(sb_6502_t *cpu, sb_bus_t *bus, uint8_t opcode) {
  cpu->p &= ~SB_6502_DECIMAL;
}
static void op_SED(sb_6502_t *cpu, sb_bus_t *bus, uint8_t opcode) {
  cpu->p |= SB_6502_DECIMAL;
}
static void op_NOP(sb_6502_t *cpu, sb_bus_t *bus,
                   uint8_t opcode) { /* do nothing */ }
...
static void op_PHP(sb_6502_t *cpu, sb_bus_t *bus, uint8_t opcode) {
  ...
  sb_bus_write(bus, 0x0100 | (uint16_t)cpu->s,
...
void sb_6502_init_opcodes(void) {
  ...
  // LDA: 8 variants
  opcodes[0xA9] =
      (sb_6502_opcode_t){"LDA", 2, 2, false, addr_immediate, op_LDA};
  opcodes[0xA5] =
      (sb_6502_opcode_t){"LDA", 2, 3, false, addr_zero_page, op_LDA};
  opcodes[0xB5] =
      (sb_6502_opcode_t){"LDA", 2, 4, false, addr_zero_page_x, op_LDA};
  opcodes[0xAD] = (sb_6502_opcode_t){"LDA", 3, 4, false, addr_absolute, op_LDA};
  opcodes[0xBD] =
      (sb_6502_opcode_t){"LDA", 3, 4, true, addr_absolute_x, op_LDA};
  opcodes[0xB9] =
      (sb_6502_opcode_t){"LDA", 3, 4, true, addr_absolute_y, op_LDA};
  opcodes[0xA1] =
      (sb_6502_opcode_t){"LDA", 2, 6, false, addr_indexed_indirect, op_LDA};
  opcodes[0xB1] =
      (sb_6502_opcode_t){"LDA", 2, 5, true, addr_indirect_indexed, op_LDA};

  // LDX 5 variants
  opcodes[0xA2] =
      (sb_6502_opcode_t){"LDX", 2, 2, false, addr_immediate, op_LDX};
  opcodes[0xA6] =
      (sb_6502_opcode_t){"LDX", 2, 3, false, addr_zero_page, op_LDX};
  opcodes[0xB6] =
      (sb_6502_opcode_t){"LDX", 2, 4, false, addr_zero_page_y, op_LDX};
  opcodes[0xAE] = (sb_6502_opcode_t){"LDX", 3, 4, false, addr_absolute, op_LDX};
  opcodes[0xBE] =
      (sb_6502_opcode_t){"LDX", 3, 4, true, addr_absolute_y, op_LDX};

  // LDY: 5 variants
  opcodes[0xA0] =
      (sb_6502_opcode_t){"LDY", 2, 2, false, addr_immediate, op_LDY};
  opcodes[0xA4] =
      (sb_6502_opcode_t){"LDY", 2, 3, false, addr_zero_page, op_LDY};
  opcodes[0xB4] =
      (sb_6502_opcode_t){"LDY", 2, 4, false, addr_zero_page_x, op_LDY};
  opcodes[0xAC] = (sb_6502_opcode_t){"LDY", 3, 4, false, addr_absolute, op_LDY};
  opcodes[0xBC] =
      (sb_6502_opcode_t){"LDY", 3, 4, true, addr_absolute_x, op_LDY};

  // STA: 7 variants (no immediate)
  opcodes[0x85] =
      (sb_6502_opcode_t){"STA", 2, 3, false, addr_zero_page, op_STA};
  opcodes[0x95] =
      (sb_6502_opcode_t){"STA", 2, 4, false, addr_zero_page_x, op_STA};
  opcodes[0x8D] = (sb_6502_opcode_t){"STA", 3, 4, false, addr_absolute, op_STA};
  opcodes[0x9D] =
      (sb_6502_opcode_t){"STA", 3, 5, false, addr_absolute_x, op_STA};
  opcodes[0x99] =
      (sb_6502_opcode_t){"STA", 3, 5, false, addr_absolute_y, op_STA};
  opcodes[0x81] =
      (sb_6502_opcode_t){"STA", 2, 6, false, addr_indexed_indirect, op_STA};
  opcodes[0x91] =
      (sb_6502_opcode_t){"STA", 2, 6, false, addr_indirect_indexed, op_STA};

  // STX: 3 variants
  opcodes[0x86] =
      (sb_6502_opcode_t){"STX", 2, 3, false, addr_zero_page, op_STX};
  opcodes[0x96] =
      (sb_6502_opcode_t){"STX", 2, 4, false, addr_zero_page_y, op_STX};
  opcodes[0x8E] = (sb_6502_opcode_t){"STX", 3, 4, false, addr_absolute, op_STX};

  // STY: 3 variants
  opcodes[0x84] =
      (sb_6502_opcode_t){"STY", 2, 3, false, addr_zero_page, op_STY};
  opcodes[0x94] =
      (sb_6502_opcode_t){"STY", 2, 4, false, addr_zero_page_x, op_STY};
  opcodes[0x8C] = (sb_6502_opcode_t){"STY", 3, 4, false, addr_absolute, op_STY};

  // ADC: 8 variants
  opcodes[0x69] =
      (sb_6502_opcode_t){"ADC", 2, 2, false, addr_immediate, op_ADC};
  opcodes[0x65] =
      (sb_6502_opcode_t){"ADC", 2, 3, false, addr_zero_page, op_ADC};
  opcodes[0x75] =
      (sb_6502_opcode_t){"ADC", 2, 4, false, addr_zero_page_x, op_ADC};
  opcodes[0x6D] = (sb_6502_opcode_t){"ADC", 3, 4, false, addr_absolute, op_ADC};
  opcodes[0x7D] =
      (sb_6502_opcode_t){"ADC", 3, 4, true, addr_absolute_x, op_ADC};
  opcodes[0x79] =
      (sb_6502_opcode_t){"ADC", 3, 4, true, addr_absolute_y, op_ADC};
  opcodes[0x61] =
      (sb_6502_opcode_t){"ADC", 2, 6, false, addr_indexed_indirect, op_ADC};
  opcodes[0x71] =
      (sb_6502_opcode_t){"ADC", 2, 5, true, addr_indirect_indexed, op_ADC};

  // SBC: 8 variants
  opcodes[0xE9] =
      (sb_6502_opcode_t){"SBC", 2, 2, false, addr_immediate, op_SBC};
  opcodes[0xE5] =
      (sb_6502_opcode_t){"SBC", 2, 3, false, addr_zero_page, op_SBC};
  opcodes[0xF5] =
      (sb_6502_opcode_t){"SBC", 2, 4, false, addr_zero_page_x, op_SBC};
  opcodes[0xED] = (sb_6502_opcode_t){"SBC", 3, 4, false, addr_absolute, op_SBC};
  opcodes[0xFD] =
      (sb_6502_opcode_t){"SBC", 3, 4, true, addr_absolute_x, op_SBC};
  opcodes[0xF9] =
      (sb_6502_opcode_t){"SBC", 3, 4, true, addr_absolute_y, op_SBC};
  opcodes[0xE1] =
      (sb_6502_opcode_t){"SBC", 2, 6, false, addr_indexed_indirect, op_SBC};
  opcodes[0xF1] =
      (sb_6502_opcode_t){"SBC", 2, 5, true, addr_indirect_indexed, op_SBC};
  ...
  // AND: 8 variants
  opcodes[0x29] =
      (sb_6502_opcode_t){"AND", 2, 2, false, addr_immediate, op_AND};
  opcodes[0x25] =
      (sb_6502_opcode_t){"AND", 2, 3, false, addr_zero_page, op_AND};
  opcodes[0x35] =
      (sb_6502_opcode_t){"AND", 2, 4, false, addr_zero_page_x, op_AND};
  opcodes[0x2D] = (sb_6502_opcode_t){"AND", 3, 4, false, addr_absolute, op_AND};
  opcodes[0x3D] =
      (sb_6502_opcode_t){"AND", 3, 4, true, addr_absolute_x, op_AND};
  opcodes[0x39] =
      (sb_6502_opcode_t){"AND", 3, 4, true, addr_absolute_y, op_AND};
  opcodes[0x21] =
      (sb_6502_opcode_t){"AND", 2, 6, false, addr_indexed_indirect, op_AND};
  opcodes[0x31] =
      (sb_6502_opcode_t){"AND", 2, 5, true, addr_indirect_indexed, op_AND};

  // ORA: 8 variants
  opcodes[0x09] =
      (sb_6502_opcode_t){"ORA", 2, 2, false, addr_immediate, op_ORA};
  opcodes[0x05] =
      (sb_6502_opcode_t){"ORA", 2, 3, false, addr_zero_page, op_ORA};
  opcodes[0x15] =
      (sb_6502_opcode_t){"ORA", 2, 4, false, addr_zero_page_x, op_ORA};
  opcodes[0x0D] = (sb_6502_opcode_t){"ORA", 3, 4, false, addr_absolute, op_ORA};
  opcodes[0x1D] =
      (sb_6502_opcode_t){"ORA", 3, 4, true, addr_absolute_x, op_ORA};
  opcodes[0x19] =
      (sb_6502_opcode_t){"ORA", 3, 4, true, addr_absolute_y, op_ORA};
  opcodes[0x01] =
      (sb_6502_opcode_t){"ORA", 2, 6, false, addr_indexed_indirect, op_ORA};
  opcodes[0x11] =
      (sb_6502_opcode_t){"ORA", 2, 5, true, addr_indirect_indexed, op_ORA};

  // EOR: 8 variants
  opcodes[0x49] =
      (sb_6502_opcode_t){"EOR", 2, 2, false, addr_immediate, op_EOR};
  opcodes[0x45] =
      (sb_6502_opcode_t){"EOR", 2, 3, false, addr_zero_page, op_EOR};
  opcodes[0x55] =
      (sb_6502_opcode_t){"EOR", 2, 4, false, addr_zero_page_x, op_EOR};
  opcodes[0x4D] = (sb_6502_opcode_t){"EOR", 3, 4, false, addr_absolute, op_EOR};
  opcodes[0x5D] =
      (sb_6502_opcode_t){"EOR", 3, 4, true, addr_absolute_x, op_EOR};
  opcodes[0x59] =
      (sb_6502_opcode_t){"EOR", 3, 4, true, addr_absolute_y, op_EOR};
  opcodes[0x41] =
      (sb_6502_opcode_t){"EOR", 2, 6, false, addr_indexed_indirect, op_EOR};
  opcodes[0x51] =
      (sb_6502_opcode_t){"EOR", 2, 5, true, addr_indirect_indexed, op_EOR};

  // CMP: 8 variants
  opcodes[0xC9] =
      (sb_6502_opcode_t){"CMP", 2, 2, false, addr_immediate, op_CMP};
  opcodes[0xC5] =
      (sb_6502_opcode_t){"CMP", 2, 3, false, addr_zero_page, op_CMP};
  opcodes[0xD5] =
      (sb_6502_opcode_t){"CMP", 2, 4, false, addr_zero_page_x, op_CMP};
  opcodes[0xCD] = (sb_6502_opcode_t){"CMP", 3, 4, false, addr_absolute, op_CMP};
  opcodes[0xDD] =
      (sb_6502_opcode_t){"CMP", 3, 4, true, addr_absolute_x, op_CMP};
  opcodes[0xD9] =
      (sb_6502_opcode_t){"CMP", 3, 4, true, addr_absolute_y, op_CMP};
  opcodes[0xC1] =
      (sb_6502_opcode_t){"CMP", 2, 6, false, addr_indexed_indirect, op_CMP};
  opcodes[0xD1] =
      (sb_6502_opcode_t){"CMP", 2, 5, true, addr_indirect_indexed, op_CMP};

  // CPX: 3 variants
  opcodes[0xE0] =
      (sb_6502_opcode_t){"CPX", 2, 2, false, addr_immediate, op_CPX};
  opcodes[0xE4] =
      (sb_6502_opcode_t){"CPX", 2, 3, false, addr_zero_page, op_CPX};
  opcodes[0xEC] = (sb_6502_opcode_t){"CPX", 3, 4, false, addr_absolute, op_CPX};

  // CPY: 3 variants
  opcodes[0xC0] =
      (sb_6502_opcode_t){"CPY", 2, 2, false, addr_immediate, op_CPY};
  opcodes[0xC4] =
      (sb_6502_opcode_t){"CPY", 2, 3, false, addr_zero_page, op_CPY};
  opcodes[0xCC] = (sb_6502_opcode_t){"CPY", 3, 4, false, addr_absolute, op_CPY};

  // BIT: 2 variants
  opcodes[0x24] =
      (sb_6502_opcode_t){"BIT", 2, 3, false, addr_zero_page, op_BIT};
  opcodes[0x2C] = (sb_6502_opcode_t){"BIT", 3, 4, false, addr_absolute, op_BIT};

  // ASL: 5 variants
  opcodes[0x0A] =
      (sb_6502_opcode_t){"ASL", 1, 2, false, addr_accumulator, op_ASL};
  opcodes[0x06] =
      (sb_6502_opcode_t){"ASL", 2, 5, false, addr_zero_page, op_ASL};
  opcodes[0x16] =
      (sb_6502_opcode_t){"ASL", 2, 6, false, addr_zero_page_x, op_ASL};
  opcodes[0x0E] = (sb_6502_opcode_t){"ASL", 3, 6, false, addr_absolute, op_ASL};
  opcodes[0x1E] =
      (sb_6502_opcode_t){"ASL", 3, 7, false, addr_absolute_x, op_ASL};

  // LSR: 5 variants
  opcodes[0x4A] =
      (sb_6502_opcode_t){"LSR", 1, 2, false, addr_accumulator, op_LSR};
  opcodes[0x46] =
      (sb_6502_opcode_t){"LSR", 2, 5, false, addr_zero_page, op_LSR};
  opcodes[0x56] =
      (sb_6502_opcode_t){"LSR", 2, 6, false, addr_zero_page_x, op_LSR};
  opcodes[0x4E] = (sb_6502_opcode_t){"LSR", 3, 6, false, addr_absolute, op_LSR};
  opcodes[0x5E] =
      (sb_6502_opcode_t){"LSR", 3, 7, false, addr_absolute_x, op_LSR};

  // ROL: 5 variants
  opcodes[0x2A] =
      (sb_6502_opcode_t){"ROL", 1, 2, false, addr_accumulator, op_ROL};
  opcodes[0x26] =
      (sb_6502_opcode_t){"ROL", 2, 5, false, addr_zero_page, op_ROL};
  opcodes[0x36] =
      (sb_6502_opcode_t){"ROL", 2, 6, false, addr_zero_page_x, op_ROL};
  opcodes[0x2E] = (sb_6502_opcode_t){"ROL", 3, 6, false, addr_absolute, op_ROL};
  opcodes[0x3E] =
      (sb_6502_opcode_t){"ROL", 3, 7, false, addr_absolute_x, op_ROL};

  // ROR: 5 variants
  opcodes[0x6A] =
      (sb_6502_opcode_t){"ROR", 1, 2, false, addr_accumulator, op_ROR};
  opcodes[0x66] =
      (sb_6502_opcode_t){"ROR", 2, 5, false, addr_zero_page, op_ROR};
  opcodes[0x76] =
      (sb_6502_opcode_t){"ROR", 2, 6, false, addr_zero_page_x, op_ROR};
  opcodes[0x6E] = (sb_6502_opcode_t){"ROR", 3, 6, false, addr_absolute, op_ROR};
  opcodes[0x7E] =
      (sb_6502_opcode_t){"ROR", 3, 7, false, addr_absolute_x, op_ROR};

  // INC: 4 variants
  opcodes[0xE6] =
      (sb_6502_opcode_t){"INC", 2, 5, false, addr_zero_page, op_INC};
  opcodes[0xF6] =
      (sb_6502_opcode_t){"INC", 2, 6, false, addr_zero_page_x, op_INC};
  opcodes[0xEE] = (sb_6502_opcode_t){"INC", 3, 6, false, addr_absolute, op_INC};
  opcodes[0xFE] =
      (sb_6502_opcode_t){"INC", 3, 7, false, addr_absolute_x, op_INC};

  // DEC: 4 variants
  opcodes[0xC6] =
      (sb_6502_opcode_t){"DEC", 2, 5, false, addr_zero_page, op_DEC};
  opcodes[0xD6] =
      (sb_6502_opcode_t){"DEC", 2, 6, false, addr_zero_page_x, op_DEC};
  opcodes[0xCE] = (sb_6502_opcode_t){"DEC", 3, 6, false, addr_absolute, op_DEC};
  opcodes[0xDE] =
      (sb_6502_opcode_t){"DEC", 3, 7, false, addr_absolute_x, op_DEC};
  ...
  opcodes[0xE2] =
      (sb_6502_opcode_t){"NOP", 2, 2, false, addr_immediate, op_NOP};
  opcodes[0x04] =
      (sb_6502_opcode_t){"NOP", 2, 3, false, addr_immediate, op_NOP};
  opcodes[0x44] =
      (sb_6502_opcode_t){"NOP", 2, 3, false, addr_immediate, op_NOP};
  opcodes[0x64] =
      (sb_6502_opcode_t){"NOP", 2, 3, false, addr_immediate, op_NOP};
  opcodes[0x14] =
      (sb_6502_opcode_t){"NOP", 2, 4, false, addr_immediate, op_NOP};
  opcodes[0x34] =
      (sb_6502_opcode_t){"NOP", 2, 4, false, addr_immediate, op_NOP};
  opcodes[0x54] =
      (sb_6502_opcode_t){"NOP", 2, 4, false, addr_immediate, op_NOP};
  ...
  opcodes[0x1C] =
      (sb_6502_opcode_t){"NOP", 3, 4, true, addr_absolute_x, op_NOP};
  opcodes[0x3C] =
      (sb_6502_opcode_t){"NOP", 3, 4, true, addr_absolute_x, op_NOP};
  opcodes[0x5C] =
      (sb_6502_opcode_t){"NOP", 3, 4, true, addr_absolute_x, op_NOP};
  ...
  opcodes[0xA7] =
      (sb_6502_opcode_t){"LAX", 2, 3, false, addr_zero_page, op_LAX};
  opcodes[0xB7] =
      (sb_6502_opcode_t){"LAX", 2, 4, false, addr_zero_page_y, op_LAX};
  opcodes[0xAF] = (sb_6502_opcode_t){"LAX", 3, 4, false, addr_absolute, op_LAX};
  opcodes[0xBF] =
      (sb_6502_opcode_t){"LAX", 3, 4, true, addr_absolute_y, op_LAX};
  opcodes[0xA3] =
      (sb_6502_opcode_t){"LAX", 2, 6, false, addr_indexed_indirect, op_LAX};
  opcodes[0xB3] =
      (sb_6502_opcode_t){"LAX", 2, 5, true, addr_indirect_indexed, op_LAX};

  opcodes[0x87] =
      (sb_6502_opcode_t){"SAX", 2, 3, false, addr_zero_page, op_SAX};
  opcodes[0x97] =
      (sb_6502_opcode_t){"SAX", 2, 4, false, addr_zero_page_y, op_SAX};
  opcodes[0x8F] = (sb_6502_opcode_t){"SAX", 3, 4, false, addr_absolute, op_SAX};
  opcodes[0x83] =
      (sb_6502_opcode_t){"SAX", 2, 6, false, addr_indexed_indirect, op_SAX};

  opcodes[0xC7] =
      (sb_6502_opcode_t){"DCP", 2, 5, false, addr_zero_page, op_DCP};
  opcodes[0xD7] =
      (sb_6502_opcode_t){"DCP", 2, 6, false, addr_zero_page_x, op_DCP};
  opcodes[0xCF] = (sb_6502_opcode_t){"DCP", 3, 6, false, addr_absolute, op_DCP};
  opcodes[0xDF] =
      (sb_6502_opcode_t){"DCP", 3, 7, false, addr_absolute_x, op_DCP};
  opcodes[0xDB] =
      (sb_6502_opcode_t){"DCP", 3, 7, false, addr_absolute_y, op_DCP};
  opcodes[0xC3] =
      (sb_6502_opcode_t){"DCP", 2, 8, false, addr_indexed_indirect, op_DCP};
  opcodes[0xD3] =
      (sb_6502_opcode_t){"DCP", 2, 8, false, addr_indirect_indexed, op_DCP};

  opcodes[0xE7] =
      (sb_6502_opcode_t){"ISB", 2, 5, false, addr_zero_page, op_ISB};
  opcodes[0xF7] =
      (sb_6502_opcode_t){"ISB", 2, 6, false, addr_zero_page_x, op_ISB};
  opcodes[0xEF] = (sb_6502_opcode_t){"ISB", 3, 6, false, addr_absolute, op_ISB};
  opcodes[0xFF] =
      (sb_6502_opcode_t){"ISB", 3, 7, false, addr_absolute_x, op_ISB};
  opcodes[0xFB] =
      (sb_6502_opcode_t){"ISB", 3, 7, false, addr_absolute_y, op_ISB};
  opcodes[0xE3] =
      (sb_6502_opcode_t){"ISB", 2, 8, false, addr_indexed_indirect, op_ISB};
  opcodes[0xF3] =
      (sb_6502_opcode_t){"ISB", 2, 8, false, addr_indirect_indexed, op_ISB};

  opcodes[0x07] =
      (sb_6502_opcode_t){"SLO", 2, 5, false, addr_zero_page, op_SLO};
  opcodes[0x17] =
      (sb_6502_opcode_t){"SLO", 2, 6, false, addr_zero_page_x, op_SLO};
  opcodes[0x0F] = (sb_6502_opcode_t){"SLO", 3, 6, false, addr_absolute, op_SLO};
  opcodes[0x1F] =
      (sb_6502_opcode_t){"SLO", 3, 7, false, addr_absolute_x, op_SLO};
  opcodes[0x1B] =
      (sb_6502_opcode_t){"SLO", 3, 7, false, addr_absolute_y, op_SLO};
  opcodes[0x03] =
      (sb_6502_opcode_t){"SLO", 2, 8, false, addr_indexed_indirect, op_SLO};
  opcodes[0x13] =
      (sb_6502_opcode_t){"SLO", 2, 8, false, addr_indirect_indexed, op_SLO};

  opcodes[0x27] =
      (sb_6502_opcode_t){"RLA", 2, 5, false, addr_zero_page, op_RLA};
  opcodes[0x37] =
      (sb_6502_opcode_t){"RLA", 2, 6, false, addr_zero_page_x, op_RLA};
  opcodes[0x2F] = (sb_6502_opcode_t){"RLA", 3, 6, false, addr_absolute, op_RLA};
  opcodes[0x3F] =
      (sb_6502_opcode_t){"RLA", 3, 7, false, addr_absolute_x, op_RLA};
  opcodes[0x3B] =
      (sb_6502_opcode_t){"RLA", 3, 7, false, addr_absolute_y, op_RLA};
  opcodes[0x23] =
      (sb_6502_opcode_t){"RLA", 2, 8, false, addr_indexed_indirect, op_RLA};
  opcodes[0x33] =
      (sb_6502_opcode_t){"RLA", 2, 8, false, addr_indirect_indexed, op_RLA};

  opcodes[0x47] =
      (sb_6502_opcode_t){"SRE", 2, 5, false, addr_zero_page, op_SRE};
  opcodes[0x57] =
      (sb_6502_opcode_t){"SRE", 2, 6, false, addr_zero_page_x, op_SRE};
  opcodes[0x4F] = (sb_6502_opcode_t){"SRE", 3, 6, false, addr_absolute, op_SRE};
  opcodes[0x5F] =
      (sb_6502_opcode_t){"SRE", 3, 7, false, addr_absolute_x, op_SRE};
  opcodes[0x5B] =
      (sb_6502_opcode_t){"SRE", 3, 7, false, addr_absolute_y, op_SRE};
  opcodes[0x43] =
      (sb_6502_opcode_t){"SRE", 2, 8, false, addr_indexed_indirect, op_SRE};
  opcodes[0x53] =
      (sb_6502_opcode_t){"SRE", 2, 8, false, addr_indirect_indexed, op_SRE};

  opcodes[0x67] =
      (sb_6502_opcode_t){"RRA", 2, 5, false, addr_zero_page, op_RRA};
  opcodes[0x77] =
      (sb_6502_opcode_t){"RRA", 2, 6, false, addr_zero_page_x, op_RRA};
  opcodes[0x6F] = (sb_6502_opcode_t){"RRA", 3, 6, false, addr_absolute, op_RRA};
  opcodes[0x7F] =
      (sb_6502_opcode_t){"RRA", 3, 7, false, addr_absolute_x, op_RRA};
  opcodes[0x7B] =
      (sb_6502_opcode_t){"RRA", 3, 7, false, addr_absolute_y, op_RRA};
  opcodes[0x63] =
      (sb_6502_opcode_t){"RRA", 2, 8, false, addr_indexed_indirect, op_RRA};
  opcodes[0x73] =
